...
from flaskblog.forms import RegistrationForm, LoginForm, PostForm,ResetPasswordForm,RequestResetForm
...
def home():
    ...
    app.logger.debug("Executing from the home route")
    app.logger.warning("A warning just occured")
